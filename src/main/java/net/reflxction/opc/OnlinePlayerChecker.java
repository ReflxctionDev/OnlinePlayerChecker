...
import net.reflxction.opc.proxy.IProxy;
import net.reflxction.opc.settings.Settings;
import net.reflxction.opc.utils.Reference;

import java.io.File;

/**
 * OnlinePlayerChecker: A very simple mod for checking whether a player is online or not
 */
@Mod(
...
public class OnlinePlayerChecker {
     ...
     */
    static {
        config = new Configuration(new File("config/opc-config.cfg"));
